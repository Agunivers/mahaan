...
if is_module_loaded(FILENAME):
    ...
    __help__ = """
*Admin only:*
- /logchannel: الحصول على معلومات قناة تسجيل الدخول
- /setlog: اضبط قناة السجل.
- /unsetlog: إلغاء تأمين قناة السجل.

يتم تعيين قناة السجل بواسطة: - إضافة BOT إلى القناة المطلوبة (كمسؤول!) - إرسال / Setlog في القناة - إعادة توجيه / SetLog إلى المجموعة
"""
