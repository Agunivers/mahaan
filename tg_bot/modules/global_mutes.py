...
def ungmute(bot: Bot, update: Update, args: List[str]):
    ...
    message.reply_text(" {}    .".format(user_chat.first_name))
    ...
    for chat in chats:
        ...
        try:
            ...
            if excp.message == "User is an administrator of the chat":
                ...
                message.reply_text("    GET : {}".format(excp.message))
                bot.send_message(OWNER_ID, "    GET : {}".format(excp.message))
                return
        except TelegramError:
            pass
...
def __stats__():
    return "{}  gmuted.".format(sql.num_gmuted_users())
...
def __chat_settings__(chat_id, user_id):
    return "   * Gamutes *: `{}`.".format(sql.does_chat_gmute(chat_id))


__help__ = """
*Admin only:*
 - /gmutestat <on/off/yes/no>:             .
  Games                .     \             .        \
/gmutestat
"""
