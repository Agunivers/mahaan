...
*Admin only:*
 ...
 - /goodbye -> نفس الاستخدام و Args مثل /welcome.
 - /setwelcome <sometext>: تعيين رسالة ترحيب مخصصة.إذا تم استخدامه للرد على الوسائط ، يستخدم تلك الوسائط.
 - /setgoodbye <sometext>: تعيين رسالة وداع مخصصة. إذا تم استخدامه للرد على الوسائط ، يستخدم تلك الوسائط.
 ...
 - /clearjoin <on/off>: عندما ينضم شخص ما ، حاول حذف * المستخدم * الذي انضم إلى الرسالة الجماعية.
